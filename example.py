...
if __name__ == '__main__':
    ...
    # delay the miner1 by 5 seconds to check that miner2 can connect to it successfully
    gevent.sleep(5)
    print('Starting MyMiner1 on port 16001')
    miner1.start()

    # delay the mine by 10 seconds to check that miner can connect to it successfully even if it was started later on
    gevent.sleep(10)
